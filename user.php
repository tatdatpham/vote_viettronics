...
<section class="breadcrumbs">
	<div class="container">
		<ul class="horizontal_list clearfix bc_list f_size_medium">
			...
			<li><a href="#" class="default_t_color"><?php echo $obj->fullname;?></a></li>
		</ul>
	</div>
</section>
	<!--content-->
				      ...
				      <div id="text-popup" class="danger-popup mfp-with-anim mfp-hide">
							<div class="row">
								...
								<form method="POST">
									...
									<div class="col-xs-7"><img src="images/<?php echo $obj->avatar;?>" class="avatar img-circle" alt="avatar"><?php echo $obj->fullname;?>
									</div>
									<div class="col-xs-3">
