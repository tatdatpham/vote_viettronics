...
INSERT INTO `account` VALUES ('5', 'thongbm@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Bùi Minh Thông', 'avatar-5.jpg', '1', 'Công nghệ phần mềm', 'Sở hữu một chiếc ô tô ở Việt Nam là cả một vấn đề không hề đơn giản, vì ngoài việc mua xe với mức giá cao do chịu nhiều loại thuế thì trong quá trình sử dụng nó chúng ta còn phải gánh thêm rất nhiều chi phí nuôi xe khác', '2');
...
INSERT INTO `account` VALUES ('7', 'sennt@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Nguyễn Thị Sen', 'avatar-7.jpg', '2', 'Mạng máy tính', 'Đúng như tên gọi của nó, Fire HD Kids Edition là một chiếc tablet dành riêng cho trẻ em và Amazon đã rất cố gắng làm cho nó phù hợp nhất có thể đối với lứa tuổi thiếu nhi. Mặc dù nó mắc hơn bản Fire HD thường 50 USD nhưng bù lại các bậc cha mẹ sẽ yên tâm hơn nhiều vì Amazon chấp nhận bảo hành tất cả mọi sự cố hỏng hóc trong vòng 2 năm và trả lại máy mới.', '2');
...
-- ----------------------------
INSERT INTO `vote_time` VALUES ('1', '2014-09-19 21:02:20', '2014-09-21 19:02:29', '0');
